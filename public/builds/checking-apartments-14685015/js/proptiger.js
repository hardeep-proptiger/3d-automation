$(document).ready(function() {
    ...
    var modelsLocation = "./assets/proptiger";
    ...
    proptigerObj.urlGDataFile = proptigerObj.strStoragePath + "GalaxyProps.xml";

    //

    /**
     * You get the system specifications, like 'You are running MacOS on PC.'
     */
    ...
    manager.add([pan, tap]);
    manager.on("pan singletap", onTouch);
    ...
    g_cSystemSpecs.fUseGalaxy ? initMetadataUILayer(g_htmlCanvas) : ( document.getElementById('left-pane').style.visibility = 'hidden', document.getElementById('bottom-pane').style.visibility = 'hidden' ) //document.getElementById("title").innerHTML = (testEnvironment + " : " + projectName) );
