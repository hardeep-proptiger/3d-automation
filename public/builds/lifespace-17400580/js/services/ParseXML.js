function parseSphereProps( strStoragePath, urlSDataFile) {
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            for (var aaConnectionGraph = [], aPanoSpheres = [], aRawConnections = [], i = 0; i < NoOfSpheres; i++) {
                var sphereInfo = {};
                ...
                aRawConnections[sphereInfo.nSphereId] = Connections[i] && Connections[i].childNodes[0] && "" !== Connections[i].childNodes[0].nodeValue ? Connections[i].childNodes[0].nodeValue: '';
            }
            ...
            returnObj.rawConnections = aRawConnections;
        }
    });
    return returnObj
}
