...
var DeviceOrientationController = function ( object, domElement ) {
    ...
    var createRotationMatrix = function () {
        ...
        var worldEuler = new THREE.Euler( -Math.PI / 2, 0, 0, 'XYZ' ); // - PI/2 around the x-axis
        ...
        return function (alpha, beta, gamma, screenOrientation) {
            ...
            //var track = 'alpha-->'+ alpha+' beta-->'+ beta+' gamma-->'+ gamma;
    ...
    this.updateManualMove = function () {
        ...
        var zoomFactor, minZoomFactor = 0; // maxZoomFactor = Infinity
        ...
        return function () {
            ...
            if ( alpha !== 0 && beta !== 0 && gamma !== 0) {
                ...
                if ( this.useQuaternions ) {
                    ...
                    //g_cRenderer.m_cPanowalk.updateRotation(0,0);
